...
let originalWords = [
  "ориґінал", "делеґат", "колеґа", "леґенда", "булдоґ", "ґолкіпер", "ґалянтерія", "ляґуна", "льозунґ", "металюрґія", "альґебра", "ґвельфи", "ґольф", "реґулятор", "аґент", "аґроном", "бравнінґ", "гідальґо", "гуґеноти", "ґарантія", "ґвардія", "ґібелін", "ґіляндра", "ґлядіятор", "ґнайс", "ґрандіозний", "дириґент", "елеґантний", "інтеліґент", "лінґвіст", "міґрація", "аґітація", "зфалшувати", "зфотографувати", "зформувати", "західній", "східній", "трикутній", "випроваджати", "голодівка", "манастир", "мариво", "салітра", "соняшний", "шаравари", "гієроґліф", "гістерія", "гураґан", "амнестія", "хемія", "метода", "роля", "спіраля", "евнух", "епархія", "мусулманин", "носталгія", "шелф", "евфорія", "невтральний", "неврологія", "авул", "богдохан", "вермічелі", "маштаб", "моххамеданин", "претенсія", "бурмістер", "маґістер", "міністер", "циліндер", "матеріял", "соціялізм", "спеціяльний", "мініятюрний", "паліятив", "амоніяк", "діялект", "тріюмф", "тріюмвірат", "радіюс", "консиліюм", "медіюм", "ортографія", "деклямація", "проклямація", "флякон", "флямінґо","аероплян", "балада", "балянс", "лямпа", "доляр", "плян", "діялог", "новеля", "бльокада", "сольо", "фльота", "блюза", "кольорит", "пльомба", "льомбард", "лябораторія", "парлямент", "діяспора", "ганчар", "народній", "танґо", "прогноза", "бензина", "ґардероба", "заля", "оркестра", "парада", "пляжа", "салата", "варіянт", "ініціятива", "соціяльний", "балькон", "льокальний", "мармеляда", "рідній", "кольоквіюм", "целюльоза", "целульоїд", "альфабет", "бухгалтер", "альхемія", "п'єдесталь", "алькоголь", "комедіянт", "пляц", "ар'єрґард", "біл", "капсуля", "лява", "баляда", "клявіш", "девіза", "синтакса", "діагноза", "кооператива", "візита", "етикета", "европейський", "атлантійський", "меморіял", "кльовн"
];

// Words set 2 - representing modern standardized Ukrainian words (1933/contemporary version)
let modernWords = [
  "оригінал", "делегат", "колега", "легенда", "бульдог", "голкіпер", "галантерея", "лагуна", "лозунг", "металургія", "альгебра", "гвельфи", "гольф", "регулятор", "агент", "агроном", "браунінг", "гідальго", "гугеноти", "гарантія", "гвардія", "гібелін", "гіляндра", "гладіатор", "гнайс", "грандіозний", "диригент", "елегантний", "інтелігент", "лінгвіст", "міграція", "агітація", "сфальшувати", "сфотографувати", "сформувати", "західний", "східний", "трикутний", "випроводжати", "голодовка", "монастир", "марево", "селітра", "сонячний", "шаровари", "ієрогліф", "істерія", "ураган", "амністія", "хімія", "метод", "роль", "спіраль", "євнух", "єпархія", "мусульманин", "ностальгія", "шельф", "ейфорія", "нейтральний", "нейрологія", "аул", "богдихан", "вермішель", "масштаб", "магометанин", "претензія", "бурмістр", "магістр", "міністр", "циліндр", "матеріал", "соціалізм", "спеціальний", "мініатюрний", "паліатив", "амоніак", "діалект", "тріумф", "тріумвірат", "радіус", "консиліум", "медіум", "орфографія", "декламація", "прокламація", "флакон", "фламінго", "аероплан", "балада", "баланс", "лампа", "долар", "план", "діалог", "новела", "блокада", "соло", "флот", "блуза", "колорит", "пломба", "ломбард", "лабораторія", "парламент", "діаспора", "гончар", "народний", "танго", "прогноз", "бензин", "гардероба", "зал", "оркестр", "парада", "пляж", "салат", "варіант", "ініціатива", "соціальний", "балкон", "локальний", "мармелад", "рідний", "колоквіум", "целюлоза", "целулоїд", "алфавіт", "бухгалтер", "алхімія", "п'єдестал", "алкоголь", "комедіант", "плац", "ар'єргард", "біль", "капсула", "лава", "балада", "клавіш", "девіз", "синтаксис", "діагноз", "кооператив", "візит", "етикета", "європейський", "атлантичний", "меморіал", "клоун"
];
